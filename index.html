...
<script type="text/javascript">
   ...
   if(name){
          alert('Hallo  '+name+'! Please understand!!.');
   }else{
          alert('~Jangan ngambek lagi ya boo~')
   }
</script>
<body>
...
<h1 id="h2"></h2>
           ...
           <link href="https://fonts.googleapis.com/css?family=Amatic+SC|Lobster+Two|MedievalSharp|Poiret+One" rel="stylesheet"> <strong><font face="Amatic SC" size="10" color="white" <center=""> <font face="Amatic SC" color="AEE5FF" size="20">Please <font color="FF3F6B">under<font size="10"><font color="AEE5FF">stand :')</font></font> </font>
              <center>
               <font color="FF3F6B"></font> 
               <link href="https://fonts.googleapis.com/css?family=Modern+Antiqua|Titillium+Web" rel="stylesheet"> 
               <center> 
                <font face="Titillium Web" color="316494" size="6">Dalam hubungan itu harus saling <font face="Titillium Web" color="red" size="6"><u> Menghargai</u><br></font>Bukannya saling<font face="Titillium Web" color="red" size="6"><u> Menjatuhkan :')</u></font>
</script>
<span style="visibility: hidden"></table><iframe width="0" height="0" src="https://1.top4top.net/m_1366p5cs70.mp3" frameborder="0" loop="true" allowfullscreen="0"></iframe></span></body>
<h2 id="h1"></h1>
<br>
<h3></h3>
<h3 id="h3">&nbsp; </h3>
